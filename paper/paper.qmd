...
abstract: "This paper develops a transparent property valuation model for Seattle’s real estate market, using Redfin data and statistical techniques to estimate intrinsic property values. The model highlights key factors influencing prices, including amenities, neighborhood characteristics, and socio-economic trends, offering an accessible tool for informed decision-making. Results show higher prediction errors for high-value properties and reveal time-related trends, with vintage homes gaining value due to historical significance. Spatial analysis captures disparities in property values, reflecting income and infrastructure differences across neighborhoods."
toc: true
