...
```{r fig-dag, fig.width=4, fig.height=2.8, fig.cap='Multiple Causal Relationships Among Model Variables'}
dagify(
  price ~ beds,
  price ~ sqft,
  price ~ baths,
  ...
  hoa ~ sqft,
  coords = list(
    x = c(beds = 0.5, sqft = 0.9, baths = 0, price = 2, hoa = 1.6),
    y = c(beds = 0, sqft = 0.9, baths = 1, price = 0, hoa = 1.2)
  )
) |>
  ggdag() +
  theme_void()
...
```{r fig-map, fig.cap="Highest Average Predicted Listing Price in Seattle's 85 Acre Gated Community"}
